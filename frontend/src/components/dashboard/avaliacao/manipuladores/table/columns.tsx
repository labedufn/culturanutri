...
export const columns = (
  handleVisualizar: (manipulador: Manipulador) => void,
  handleExcluir: (manipulador: Manipulador) => void,
): Array<ColumnDef<Manipulador> & { sortable?: boolean }> => [
  {
      ...
      <div className="flex items-center space-x-4">
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent side="bottom" className="bg-zinc-800">
              <p className="text-white">Visualizar Manipulador</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent side="bottom" className="bg-zinc-800">
              <p className="text-white">Excluir Manipulador</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </div>
